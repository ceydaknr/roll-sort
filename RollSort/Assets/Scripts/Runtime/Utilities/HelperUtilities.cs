...
{
    /// <summary>
    ///     Utility class providing helpful methods for common operations such as retrieving the mouse's world position,
    ///     calculating direction vectors, and
    ///     determining aim direction based on an angle in degrees.
    /// </summary>
    /// <remarks>
    ///     The class includes a method to get the mouse's world position, ensuring it stays within screen bounds, a method for
    ///     calculating normalized direction
